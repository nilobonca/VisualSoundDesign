...
import { Clock, Minus, X, GripHorizontal } from 'lucide-react';
...
export default function HistoryMenu({ history, future, onRestore, onClose, isDocked = false, onDock, onInteraction }: HistoryMenuProps) {
